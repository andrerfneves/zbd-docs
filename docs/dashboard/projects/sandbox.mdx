...
Head on over to the API Reference page and enter your Sandbox API Key and one of your Test User's ZBD Username. Then click on the `Send Request` button on the top right.
