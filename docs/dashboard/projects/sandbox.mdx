...
<Frame type="glass" caption="">
  <img src="https://docs.zebedee.io/img/v2/devdash/sandbox-project-created.png" alt="ZEBEDEE Developer Dashboard | Project Created" />
</Frame>
<br />

## Test Users[​](#test-users "Direct link to heading")
...
<Frame type="glass" caption="">
  <img src="https://docs.zebedee.io/img/v2/devdash/sandbox-test-users.png" alt="ZEBEDEE Developer Dashboard | Test Users" />
</Frame>
<br />

## Topping Up Sandbox Wallet[​](#topping-up-sandbox-wallet "Direct link to heading")
...
<Frame type="glass" caption="">
  <img src="https://docs.zebedee.io/img/v2/devdash/sandbox-topup-wallet.png" alt="ZEBEDEE Developer Dashboard | Topup Sandbox Project Wallet" />
</Frame>
<br />
...
<Frame type="glass" caption="">
  <img src="https://docs.zebedee.io/img/v2/devdash/sandbox-api-key.png" alt="ZEBEDEE Developer Dashboard | Sandbox API Key" />
</Frame>
<br />
...
You may write your own HTTP client to do this test, but the simplest way is to use the _API Playground Module_ available in the [ZEBEDEE API Reference](https://docs.zebedee.io/api). On every API Reference page you will find a _ZEBEDEE API Playground Module_ on the right-hand side that you can use to directly test an API endpoint by providing it an API Key and a payload (if necessary).

<Frame type="glass" caption="Replace YOUR_API_KEY_HERE with your Sandbox API Key">
  <img src="https://docs.zebedee.io/img/v2/devdash/sandbox-doc-portal2.png" alt="ZEBEDEE API Reference - Sandbox APIs" />
</Frame>
<br />

Head on over to the API Reference page and enter your Sandbox API Key and one of your Test User's ZBD Gamertag. Then click on the `Send API Request` button on the top right.

<Frame type="glass" caption="">
  <img src="https://docs.zebedee.io/img/v2/devdash/sandbox-doc-portal.png" alt="ZEBEDEE API Reference - Sandbox APIs" />
</Frame>
<br />

If successful the API will return a `success: true` payload, it means you successfully sent Bitcoin!

Returning to the ZEBEDEE Developer Dashboard, you will notice that your Sandbox Wallet has been debited by the amount of _fake satoshis_ you sent to your Test User and that a new transaction is now reflected in the _Transactions_ table.

<Frame type="glass" caption="">
  <img src="https://docs.zebedee.io/img/v2/devdash/sandbox-wallet-post-tx.png" alt="ZEBEDEE Developer Dashboard | Sandbox Wallet" />
</Frame>
<br />
...
<Frame type="glass" caption="">
  <img src="https://docs.zebedee.io/img/v2/devdash/sandbox-tx-details.png" alt="ZEBEDEE Developer Dashboard | Sandbox Transaction Details" />
</Frame>
<br />
