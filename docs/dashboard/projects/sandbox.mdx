...
<Note>At the moment we have exposed the [**Send Bitcoin to ZBD Username Sandbox API**](/api-reference/gamertag/send-gamertag) for testing purposes. We will be adding more Sandbox APIs in the future, including the ability to create Sandbox Charges and Static Charges, as well as send Sandbox Payments.
...
Now that we have our Sandbox API Key, let's use the [**Send Bitcoin to ZBD Username Sandbox API**](/api-reference/gamertag/send-gamertag) to send some _fake satoshis_ to our Sandbox Test User.
...
You have just used the [**Send Bitcoin to ZBD Username Sandbox API**](/api-reference/gamertag/send-gamertag) to send _fake satoshis_ to your Sandbox Test User.
