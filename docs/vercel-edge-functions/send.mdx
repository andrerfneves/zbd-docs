---
title: Sending instant Bitcoin payments
...
Create a new file in the `app/api/send/route.ts` that makes a payment to a [Lightning Address](/knowledge-base/glossary) (e.g. andre@zbd.gg) with the following code:
...
<Warning>
  In order to successfully send payments through the API, you must have an active balance in the ZBD Project you are using. [Learn more about depositing funds into a ZBD Project wallet](/yo).
