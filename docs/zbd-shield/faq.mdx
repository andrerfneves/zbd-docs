...
ZBD Shield helps protect you from malicious and/or fraudulent activity by acting as a middleman between your project and the [ZBD API](/knowledge-base/zbd-api/overview). The product helps you take action against bad actors by preventing transactions on entities (ZBD Gamertags, IPs, ISPs, and Device IDs).
