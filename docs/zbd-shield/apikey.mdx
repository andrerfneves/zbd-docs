...
<Warning>If your API key is ever compromised, immediately [regenerate a new API key](/docs/dashboard/projects/api) in the [ZBD Dev Dashboard](https://dashboard.zebedee.io) and update the key in your ZBD Shield instance.</Warning>
