...
Connecting a [ZBD Dev Dashboard](https://dashboard.zebedee.io) Project to ZBD Shield is required to route transactions for that Project through your ZBD Shield instance. This will be done by inputting the applicable Project’s API key from the [ZBD Dev Dashboard](https://dashboard.zebedee.io) into ZBD Shield.

## In ZBD Dev Dashboard

1. In a separate browser tab, log in to your [ZBD Dev Dashboard](https://dashboard.zebedee.io) account.
...
<Frame caption="ZBD Dev Dashboard | API Key Screen">
  <img src="/img/v2/shield-copy-api-key.png" alt="ZBD Dev Dashboard | API Key Screen" />
</Frame>
<br />
...
<Frame caption="ZBD Shield | API Key Screen">
  <img src="/img/v2/shield-input-api-key.png" alt="ZBD Shield | API Key Screen" />
</Frame>
<br />
