...
### Getting the ZBD User Profile Data
...
### Getting the ZBD User Wallet Data
...
### Get Credentials from ZEBEDEE Developer Dashboard
...
<Frame type="glass" caption="OAuth2 Menu - ZEBEDEE Developer Dashboard">
  <img
    ...
    alt="OAuth2 Menu - ZEBEDEE Developer Dashboard"
  />
</Frame>
<br />
...
<Frame
  type="glass"
  caption="View OAuth2 Settings - ZEBEDEE Developer Dashboard"
>
  <img
    src="/img/oauth2-vs.png"
    alt="View OAuth2 Settings - ZEBEDEE Developer Dashboard"
  />
</Frame>
<br />
...
<Frame type="glass" caption="Add Redirect URLs - ZEBEDEE Developer Dashboard">
  <img
    ...
    alt="Add Redirect URLs - ZEBEDEE Developer Dashboard"
  />
</Frame>
<br />
