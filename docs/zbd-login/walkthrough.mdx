...
## Client Side[​](#client-side "Direct link to heading")
...
## Server Side[​](#server-side "Direct link to heading")
...
If you are using a library that provides PKCE guidelines, it will most likely be able to handle the initial flow (building auth URL and getting the code) just fine. In this case, feel free to jump to the [Token Section](https://www.notion.so/Login-with-ZEBEDEE-1c2c384d74eb4342bf4a9aa7967043ba).

### Building Authorization URL[​](#building-authorization-url "Direct link to heading")
...
### Getting the token and accessing ZBD API[​](#getting-the-token-and-accessing-zbd-api "Direct link to heading")
...
Once the user is successfully authenticated on ZEBEDEE Client, there is a redirect back to your app, sending `code` and `state` as query params.
...
### Client Examples[​](#client-examples "Direct link to heading")

React Native: [https://github.com/zebedeeio/login-zbd-react-native-example](https://github.com/zebedeeio/login-zbd-react-native-example)

Express: [https://github.com/zebedeeio/login-zebedee-express-example](https://github.com/zebedeeio/login-zebedee-express-example)