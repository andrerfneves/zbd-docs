...
The ZBD team is working on a lot of new features for the ZBD Streamer app, including text-to-speech, audio snippet support, and much more. That being said, the system was purposefully built open enough that more tech-savyy folks can do custom things with it.
