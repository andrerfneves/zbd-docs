...
<Frame type="glass" caption="">
  <img src="/img/TuGk4Gm.png" alt="API Docs - ZBD" />
</Frame>
<br />

  

Welcome to the ZBD ecosystem!

We are thrilled you've chosen to leverage ZBD API to introduce next-gen payments capabilities to the fabric of your applications, games, or platforms.
