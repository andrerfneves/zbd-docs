...
The [ZEBEDEE API](/api/intro) uses API Keys to authenticate requests. Each of your Projects in the [ZEBEDEE Developer Dashboard](https://dashboard.zebedee.io) will have an unique API Key that allows for the management and control over that Project's Wallet.
