...
The ZEBEDEE API follows standard HTTP response codes for handling success and error requests. If you are unfamiliar with HTTP requests, [please read more here](https://developer.mozilla.org/en-US/docs/Web/HTTP/Status).
...
| 403 | Forbidden | Request is forbidden. Make sure your IP is located in a region/country that ZEBEDEE services are available in ([check Supported Regions page for more info](https://zebedee.io/countries)). |
