...
<Tip>The API Reference also boasts a right-sidebar [API Module](/api/charges/create) which allows you to interact with the ZBD API directly from the browser with the click of a button.</Tip>