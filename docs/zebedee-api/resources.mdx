...
*   [Is Supported Region](/api/utils/is-supported) -> Fetches whether a user is located in a region ZEBEDEE services are available
*   [ZEBEDEE Production IPs](/api/utils/prod-ips) -> Fetches the static IP addresses for ZEBEDEE servers
