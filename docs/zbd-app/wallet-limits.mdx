...
The ZBD App has a built-in Bitcoin wallet that has support for sending and receiving Bitcoin in various ways. If you'd like to understand the limits of your ZBD App wallet and how to increase them, head on over to the `Wallet >> Limits` settings menu on the sidebar on the mobile app.

Below is a detailed list of the wallet limits and their values as a user increases its verification levels within the ZBD platform.
