---
title: 'Set Up a Paid Nostr Relay with ZEBEDEE API'
---

<Frame type="glass" caption="Nostr Relay Guide">
  <img src="https://i.imgur.com/JLoaHFF.png" alt="Nostr Relay Guide" />
</Frame>
<br />
...
## VM Setup[​](#vm-setup "Direct link to heading")
...
## Setup Docker + Install[​](#setup-docker--install "Direct link to heading")
...
## Setup NGINX[​](#setup-nginx "Direct link to heading")
...
### NGINX Settings[​](#nginx-settings "Direct link to heading")
...
### DNS Settings[​](#dns-settings "Direct link to heading")
...
<Frame type="glass" caption="DNS Settings for Nostr Relay">
  <img src="https://docs.zebedee.io/img/v2/guides/nostr-relay/dns.webp" alt="DNS Settings for Nostr Relay" />
</Frame>
<br />

You may need to setup a static/reserved IP address in order to map the A record to the _subdomain.mydomain.com_.

## ZEBEDEE Developer Setup[​](#zebedee-developer-setup "Direct link to heading")

Now that our VM is setup, let's get our Nostr relay hooked up to ZEBEDEE. First you're going to need a ZEBEDEE Developer Dashboard account.

*   [Sign up for a ZEBEDEE Developer Dashboard account](https://dashboard.zebedee.io/signup)

<Tip>Follow our in-depth guide on [how to setup a ZEBEDEE Developer Dashboard account](/docs/dashboard/signup) for more details.</Tip>

Once you're all set with your ZEBEDEE account, let's create a project and title it something like _Nostr Relay_.

<Frame type="glass" caption="Create Project on ZEBEDEE Developer Dashboard">
  <img src="https://docs.zebedee.io/img/v2/guides/nostr-relay/create-project.webp" alt="Create Project on ZEBEDEE Developer Dashboard" />
</Frame>
<br />
...
You will need a **Production API Key** for this integration. Sandbox API Keys are not supported yet for Nostr Relays.

To get a Production API Key, you need to click _LIVE_ on your Project dashboard.

<Frame type="glass" caption="Project Details - API">
  <img src="https://docs.zebedee.io/img/v2/guides/nostr-relay/apikey.webp" alt="Project Details - API" />
</Frame>
<br />
...
Now that we’ve gotten the ZEBEDEE API Key, let’s store it in the configuration file for Nostream and set it live!

## Nostream Setup[​](#nostream-setup "Direct link to heading")
...
### Settings.yaml Configuration[​](#settingsyaml-configuration "Direct link to heading")

Go ahead and edit the contents of your Nostream settings file. The file can be found at _.nostr/settings.yaml_

<Frame type="glass" caption="settings.yaml Configuration">
  <img src="https://docs.zebedee.io/img/v2/guides/nostr-relay/settingsyaml.webp" alt="settings.yaml Configuration" />
</Frame>
<br />
...
<Frame type="glass" caption="settings.yaml Configuration">
  <img src="https://docs.zebedee.io/img/v2/guides/nostr-relay/settingsyaml2.webp" alt="settings.yaml Configuration" />
</Frame>
<br />
...
<Frame type="glass" caption="settings.yaml Configuration">
  <img src="https://docs.zebedee.io/img/v2/guides/nostr-relay/settingsyaml3.webp" alt="settings.yaml Configuration" />
</Frame>
<br />
...
<Frame type="glass" caption="settings.yaml Configuration">
  <img src="https://docs.zebedee.io/img/v2/guides/nostr-relay/settingsyaml4.webp" alt="settings.yaml Configuration" />
</Frame>
<br />
...
## Done![​](#done "Direct link to heading")

Once you restart the relay, you should see a console that looks a little bit like this.

<Frame type="glass" caption="Nostream">
  <img src="https://docs.zebedee.io/img/v2/guides/nostr-relay/nostream.webp" alt="Nostream" />
</Frame>
<br />

The special part is `Payments Provider: zebedee` and `Pay-to-relay = enabled`. You’re all set, let’s test the relay!

## Relay Connectivity[​](#relay-connectivity "Direct link to heading")
...
<Frame type="glass" caption="WebSocket King">
  <img src="https://docs.zebedee.io/img/v2/guides/nostr-relay/websocket.webp" alt="WebSocket King" />
</Frame>
<br />
...
<Frame type="glass" caption="Nostream Relay Payment Screen">
  <img src="https://docs.zebedee.io/img/v2/guides/nostr-relay/fe.webp" alt="Nostream Relay Payment Screen" />
</Frame>
<br />
