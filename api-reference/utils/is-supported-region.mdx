...
The ZBD API is available in over 100 countries around the world. For a full list please see our [Supported Regions](https://zebedee.io/countries) page that outlines the many jurisdictions ZBD is able to conduct global financial transactions.
