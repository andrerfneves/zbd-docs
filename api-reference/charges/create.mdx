...
On a successful 200 HTTP response from the ZBD API, you should render the contents of `data.invoice.uri` in a QR code. This QR code can be scanned (and is understood) by any Bitcoin Lightning Network wallet.
