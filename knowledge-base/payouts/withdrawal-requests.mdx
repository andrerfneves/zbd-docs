...
| **callbackUrl** | _String_ | The URL ZBD services will make a POST HTTP request to with information about the Withdrawal Requests's status updates. |
