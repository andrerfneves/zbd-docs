...
api: "GET https://api.zebedee.io/v0/withdrawal-requests/:WITHDRAWAL_ID"
---
...
Use this API endpoint to fetch any specific property about a given Withdrawal Request record.

## Configuration

### Path Parameters

<ParamField required path="WITHDRAWAL_ID" type="string">
...
```bash Request
curl -L -X GET 'https://api.zebedee.io/v0/withdrawal-requests/:WITHDRAWAL_ID'
```
