...
- [Login with Zebedee Demo](#zebedee-login)
...
<Frame>
  <img src="/img/v2/guides/beamable/Untitled.png" alt="Installing Newtonsoft JSON" />
</Frame>
...
<Frame>
  <img src="/img/v2/guides/beamable/Untitled1.png" alt="Login to Beamable" />
</Frame>
...
<Frame>
  <img src="/img/v2/guides/beamable/Untitled2.png"  alt="Realm Configuration on Beamable" />
</Frame>

**Next, we will need to add a new config. Click on “+ Add Config”**

<Frame>
  <img src="/img/v2/guides/beamable/Untitled3.png" alt="Add config to realm" />
</Frame>
...
<Frame>
  <img src="/img/v2/guides/beamable/Untitled4.png" width="50%" alt="API key config" />
  <img src="/img/v2/guides/beamable/Untitled5.png" alt="Client secret config" />
</Frame>
...
<Frame>
  <img src="/img/v2/guides/beamable/Untitled6.png" alt="Realm config overview" />
</Frame>
...
<Frame>
  <img src="/img/v2/guides/beamable/Untitled7.png" alt="Open microservices manager window" />
</Frame>

Here you will see the ZebedeeMicroservice

<Frame>
  <img src="/img/v2/guides/beamable/Untitled8.png" alt="Zebedee microservice in Unity" />
</Frame>

> 💡 If you see this warning below make sure you have Docker installed.
<Frame>
  <img src="/img/v2/guides/beamable/Untitled9.png" width="500" alt="Docker warning" />
</Frame>
...
<Frame>
  <img src="/img/v2/guides/beamable/Untitled10.png" alt="Add client ID to demo scene" />
</Frame>
...
<Frame>
  <img src="/img/v2/guides/beamable/Untitled11.png" alt="Publish window in Unity" />
</Frame>
...
<Frame>
  <img src="/img/v2/guides/beamable/Untitled12.png" alt="Publishing the microservice" />
</Frame>
...
<Frame>
  <img src="/img/v2/guides/beamable/Untitled13.png" alt="Beamable dashboard microservice overview" />
</Frame>
...
<Frame>
  <img src="/img/v2/guides/beamable/Untitled14.png" alt="Login button in Unity" />
</Frame>

<Frame>
  <img src="/img/v2/guides/beamable/Untitled15.png" alt="Logged in message" />
</Frame>

- **Make sure you have the correct game in Beamable selected in Unity**

<Frame>
  <img src="/img/v2/guides/beamable/Untitled16.png" alt="Switching games" />
</Frame>

<Frame>
  <img src="/img/v2/guides/beamable/Untitled17.png" alt="Select the correct game in Beamable" />
</Frame>

- **Make sure you are in the correct Beamable Realm in Unity**

<Frame>
  <img src="/img/v2/guides/beamable/Untitled18.png" width="500" alt="Correct Beamable realm" />
</Frame>
...
<Frame>
  <img src="/img/v2/guides/beamable/Untitled19.png" alt="Docker not installed" />
</Frame>
...
<Frame>
  <img src="/img/v2/guides/beamable/Untitled20.png" alt="Microservice running" />
</Frame>

- **If you are working on a “Published" microservice. Make sure the microservice is published and deploy to the correct realm from the Beamable dashboard.**

<Frame>
  <img src="/img/v2/guides/beamable/Untitled13.png" alt="Beamable microservice dashboard overview" />
</Frame>