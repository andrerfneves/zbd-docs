...
To see sample code for how to integrate [Beamable](https://beamable.com/?referral=zbd) Microservices, view the `MyController.cs` file in the scripts directory of the ZBD Unity Package within Unity. Insert this code in applicable area(s) of your game; e.g. when you're [Sending sats to a ZBD Username](/api-reference/zbd-user/send).
